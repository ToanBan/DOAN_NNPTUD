...
const Forgot: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    // Giả lập gửi link khôi phục qua email
    setTimeout(() => {
      setIsLoading(false);
      setIsSubmitted(true);
    }, 2000);
      ...
      <div className="w-full max-w-[1100px] h-[700px] flex overflow-hidden bg-white rounded-[40px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-slate-100 m-4">
        ...
        <div className="hidden lg:flex w-1/2 relative p-12 flex-col justify-between overflow-hidden bg-[#0A0A0B]">
          ...
          <div className="relative z-10 flex items-center gap-3">
            ...
            <span className="text-white font-bold text-xl tracking-tight">FutureSocial</span>
          </div>
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl font-bold text-white leading-[1.1] mb-6 tracking-tight">
              Khôi phục <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-300">quyền truy cập.</span>
            </h1>
            <p className="text-slate-400 text-lg leading-relaxed max-w-sm">
              Đừng lo lắng, chúng tôi sẽ giúp bạn lấy lại tài khoản một cách nhanh chóng và bảo mật.
            </p>
          </div>
          ...
          <div className="relative z-10 grid grid-cols-2 gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-slate-300 font-medium">Bảo mật đa lớp</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-indigo-400">
                <Zap size={20} />
              </div>
              <span className="text-sm text-slate-300 font-medium">Xác thực nhanh</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col p-8 md:p-16 justify-center">
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-slate-500 font-medium">Nhập email của bạn để nhận liên kết khôi phục</p>
          </div>
          ...
          {!isSubmitted ? (
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    Gửi mã xác nhận <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                  </>
                )}
              </button>
            </form>
            ...
            <div className="text-center lg:text-left p-8 bg-blue-50/50 rounded-[32px] border border-blue-100">
              ...
              <h3 className="text-xl font-black text-slate-900 mb-2">Kiểm tra hộp thư!</h3>
              <p className="text-slate-600 text-sm font-medium leading-relaxed mb-6">
                Chúng tôi đã gửi một liên kết khôi phục mật khẩu đến email của bạn. Vui lòng kiểm tra cả hòm thư rác nếu không thấy.
              </p>
              <button 
          ...
          <div className="mt-10 text-center text-sm text-slate-500 font-medium">
            Bạn cần hỗ trợ? <a href="#" className="font-black text-blue-600 hover:text-blue-700 transition-colors">Liên hệ trung tâm trợ giúp</a>
          </div>
        </div>
