      ...
      <div className="w-full max-w-[1100px] h-[820px] flex overflow-hidden bg-white rounded-[40px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-slate-100 m-4">
        ...
        <div className="hidden lg:flex w-1/2 relative p-12 flex-col justify-between overflow-hidden bg-[#0A0A0B]">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl font-bold text-white leading-[1.1] mb-6 tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-300">sáng tạo của bạn.</span>
            </h1>
            <p className="text-slate-400 text-lg leading-relaxed max-w-sm">
              Tạo tài khoản chỉ trong vài giây và kết nối với hàng triệu người dùng trên toàn thế giới.
            </p>
          </div>
          ...
          <div className="relative z-10 space-y-4">
            ...
            <div className="flex items-center gap-3 text-slate-300">
              <CheckCircle2 size={18} className="text-blue-500" />
              <span className="text-sm font-medium">Không giới hạn tính năng</span>
            </div>
            <div className="flex items-center gap-3 text-slate-300">
              <CheckCircle2 size={18} className="text-blue-500" />
        ...
        <div className="w-full lg:w-1/2 flex flex-col p-8 md:p-12 overflow-y-auto custom-scrollbar">
          <div className="mb-6 text-center lg:text-left">
            <h2 className="text-3xl font-black text-slate-900 mb-2">Tạo tài khoản</h2>
            <p className="text-slate-500 font-medium">Khám phá thế giới kết nối mới ngay hôm nay</p>
          </div>
          ...
          <form className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {/* Confirm Password */}
                <div className="space-y-1.5">
                <label className="text-sm font-bold text-slate-700 ml-1">Xác nhận</label>
                <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-blue-600 transition-colors">
                    <ShieldAlert size={18} />
                    </div>
          ...
          <p className="mt-6 text-center text-sm text-slate-500 font-medium">
            Đã có tài khoản? <a href="#" className="font-black text-blue-600 hover:text-blue-700 transition-colors">Đăng nhập ngay</a>
          </p>
        </div>
