        ...
        <div className="hidden lg:flex w-1/2 relative p-12 flex-col justify-between overflow-hidden bg-[#0A0A0B]">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl font-bold text-white leading-[1.1] mb-6 tracking-tight">
              Đặt lại <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-300">mật khẩu mới.</span>
            </h1>
            <p className="text-slate-400 text-lg leading-relaxed max-w-sm">
              Hãy tạo một mật khẩu mạnh để bảo vệ tài khoản và dữ liệu cá nhân của bạn.
            </p>
          </div>
          ...
          <div className="relative z-10 grid grid-cols-2 gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-slate-300 font-medium">Mã hóa đầu cuối</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-indigo-400">
                <Zap size={20} />
              </div>
              <span className="text-sm text-slate-300 font-medium">Cập nhật tức thì</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col p-8 md:p-16 justify-center">
          {!isSuccess ? (
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                >
                  {isLoading ? (
                    ...
                    <>
                      Cập nhật mật khẩu <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                    </>
                  )}
                </button>
              </form>
            ...
            <div className="text-center lg:text-left animate-in fade-in zoom-in duration-300">
              ...
              <button 
                className="w-full py-4 bg-slate-900 hover:bg-slate-800 text-white rounded-2xl font-bold shadow-xl shadow-slate-200 transition-all flex items-center justify-center gap-2"
              >
                Đăng nhập ngay
              </button>
            </div>
          ...
          <div className="mt-10 text-center text-sm text-slate-500 font-medium">
            Gặp sự cố? <a href="#" className="font-black text-blue-600 hover:text-blue-700 transition-colors">Liên hệ kỹ thuật</a>
          </div>
        </div>
